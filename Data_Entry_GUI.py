...
tk.Button(root, text="Submit", command=submit, **btn_style).place(x=220, y=580, width=100, height=40)
tk.Button(root, text="Reset", command=reset, **btn_style).place(x=360, y=580, width=100, height=40)
tk.Button(root, text="Exit", command=root.destroy, **btn_style).place(x=500, y=580, width=100, height=40)
